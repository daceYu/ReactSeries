 ...
 */
export function checkCertValidDate(certValidDate) {
 ...
 * @return {String} 错误信息或字符串‘true’
 */
export function checkPostalCode(postcode) {
 ...
 * @return {String} 错误信息或字符串‘true’
 */
export function checkHometelnoAndMobiletelno(vcHometelno, vcMobiletelno) {
 ...
 * @return {String} 错误信息或字符串‘true’
 */
export function checkMobiletelno(vcMobiletelno) {
    if (vcMobiletelno == null || vcMobiletelno == "") {
        return '手机号码不能为空'
    }
 ...
 */
export function getPhoneNumberType(number) {
 ...
 * @return {String} 错误信息或字符串‘true’
 */
export function checkHometelno(vcHometelno) {
    if (vcHometelno == null || vcHometelno == "") {
        return '电话号码不能为空'
    }
